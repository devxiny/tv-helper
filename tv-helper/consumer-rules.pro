...
# Keep TvControlConfig and its inner classes (used for JSON serialization)
-keep class com.tools.tvhelper.TvControlConfig { *; }
-keep class com.tools.tvhelper.TvControlConfig$* { *; }

# Keep ActionPayload (used for JSON deserialization)
-keep class com.tools.tvhelper.server.TvHttpServer$ActionPayload { *; }

# Keep NanoHTTPD classes to avoid issues with internal reflection or aggressive shrinking
